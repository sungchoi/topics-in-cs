...
describe "fibonacci_nonrecursive_old" do
  it "returns the correct number from the fibonacci sequence given an index number starting with zero" do
    fibonacci_nonrecursive_old(0).should eq 0
    fibonacci_nonrecursive_old(1).should eq 1
    fibonacci_nonrecursive_old(2).should eq 1
    fibonacci_nonrecursive_old(10).should eq 55    
  end
end